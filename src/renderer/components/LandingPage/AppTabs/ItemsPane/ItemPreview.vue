<template>       
  <b-container fluid>
    ...
    <b-tooltip target="valueInput" triggers="hover" placement="top" ref="valueInputTooltip" :disabled.sync="disableValueTooltip" v-on:hide.prevent>
      {{phrases.enterValue}}
    </b-tooltip>

    <b-tooltip target="saveItemBtn" triggers="hover" placement="top" ref="saveItemBtnTooltip" v-on:hide.prevent>
      {{phrases.save}}
    </b-tooltip>
